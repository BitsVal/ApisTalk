 ...
 **/
public class ProtocolKeepAliveHandler extends AbstractSystemApisHandler {
    private final Logger logger = LoggerFactory.getLogger(ProtocolKeepAliveHandler.class);
    ...
    ProtocolType.C bindProtocolType() {
        return ProtocolType.C.FROM_CLIENT_TYPE_OF_KEEP$ALIVE;
    }
