 ...
 **/
public class ProtocolQoSReceviedHandler extends AbstractSystemApisHandler {
    private final Logger logger = LoggerFactory.getLogger(ProtocolQoSReceviedHandler.class);
    ...
    ProtocolType.C bindProtocolType() {
        return ProtocolType.C.FROM_CLIENT_TYPE_OF_RECEIVED;
    }
