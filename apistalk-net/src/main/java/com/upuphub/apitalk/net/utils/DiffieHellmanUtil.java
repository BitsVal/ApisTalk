package com.upuphub.apitalk.net.utils;
...
public class DiffieHellmanUtil {
    ...
    static {
        System.getProperties().put("jdk.crypto.KeyAgreement.legacyKDF", "true");
    }
    ...
    public static void main(String[] args) throws Exception {
        //生成甲方的密钥对
        Map<String, Object> keyMap1 = DiffieHellmanUtil.generateKey();
        //甲方的公钥 、 甲方的私钥
        byte[] publicKey1 = DiffieHellmanUtil.getPublicKey(keyMap1);
        byte[] privateKey1 = DiffieHellmanUtil.getPrivateKey(keyMap1);
        ...
        // 由甲方的公钥产生的密钥对
        Map<String, Object> keyMap2 = DiffieHellmanUtil.generateKey();
        byte[] publicKey2 = DiffieHellmanUtil.getPublicKey(keyMap2);
        byte[] privateKey2 = DiffieHellmanUtil.getPrivateKey(keyMap2);
